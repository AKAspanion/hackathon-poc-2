...
export function RisksList() {
  ...
  if (isLoading) {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Risks</h2>
  ...
  if (!risks || risks.length === 0) {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Risks</h2>
        <p className="text-gray-500 dark:text-gray-400">No risks detected</p>
      </div>
    );
  }
          ...
          >
            <div className="flex items-start justify-between mb-2">
              ...
              <div className="flex gap-2">
                ...
                <span className={`px-2 py-1 rounded text-xs font-medium ${statusColors[risk.status]}`}>
