...
export function ShipmentExposureSummary({
  ...
  return (
    <div className="space-y-4 rounded-2xl border border-light-gray bg-white p-5 shadow-sm">
      <div className="flex flex-wrap items-center gap-2">
        <div className="flex items-center gap-2 text-[16px] font-semibold text-dark-gray">
          <span className="rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-[13px] text-blue-700">
            {data.supplier_city}
          </span>
          <span className="text-medium-gray">→</span>
          <span className="rounded-full border border-purple-200 bg-purple-50 px-3 py-1 text-[13px] text-purple-700">
            {data.oem_city}
          </span>
        </div>
      ...
      <div className="rounded-xl border border-light-gray bg-off-white p-3">
        ...
        <pre className="mt-2 max-h-40 overflow-auto rounded-lg border border-light-gray bg-white p-3 text-[11px] leading-relaxed text-dark-gray">
